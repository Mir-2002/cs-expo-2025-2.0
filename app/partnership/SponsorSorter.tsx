...
export default function SponsorSorter({
  ...
  return (
    ...
    >
      {/* Subtle star accents - cosmic touch */}
      ...
      <button
        ...
        aria-label="Previous sponsor tier"
        onMouseEnter={(e) => {
      ...
      <div
        className="flex min-w-[180px] sm:min-w-[220px] items-center justify-center gap-2 px-6 py-3"
        style={{
      ...
      >
        <span
          className="font-poppins text-sm font-medium tracking-wide"
          style={{
